...
import { RiCloseLine, RiMenu3Fill } from "react-icons/ri"; // Only menu icons
...
export const ClientNavbar: React.FC<NavbarProps> = ({
  ...
  return (
    <>
      <nav className={`relative z-40 ${className}`}>
        {/* Desktop Navigation */}
        ...
        <div className="lg:hidden">
          <button
            className="p-2 -mr-2 text-gray-950 dark:text-white"
            onClick={toggleMenu}
